        ...
        <div className="flex flex-col items-center justify-center h-screen bg-gray-100 rounded-3xl">
            {permissionGranted ? (
                <div className="relative w-40 h-40">
                    {/* Compass container */}
                    <div className="absolute left-1/2 w-0.5 h-20 bg-red-500 origin-bottom transform -translate-x-1/2" style={{
                        transform: `rotate(${direction ?? 0}deg)`, // Rotate the entire compass based on direction
                    }} />
                    <div
                        className="absolute inset-0 w-full h-full rounded-full border-2 border-black text-black"
                    >
