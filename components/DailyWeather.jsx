        ...
        <div className="flex flex-col rounded-3xl backdrop-blur-3xl bg-black/5 text-white w-full items-center p-3 max-h-1/2">
            ...
            <div className="flex flex-col w-full">
                {weatherData.daily.slice(1, 8).map((day, index) => {
                    ...
                    return (
                        <div key={index} className="flex flex-row items-center last:border-none justify-between">
                            ...
                            <div className="grid grid-cols-3 items-center">
                                ...
                                <img src={`https://openweathermap.org/img/wn/${day.weather[0].icon}@2x.png`} width={150} alt={day.weather[0].description} />
