...
export default function Header() {
    const { setCity, setWeatherData, setLocation, setLatlon } = useWeather();
    ...
    const handleWeatherData = async () => {
        ...
        try {
          const { weatherData, location, latlon } = await fetchWeather(trimmedValue);
    ...
    return (
        <header className="flex flex-wrap h-auto md:h-[5vh] md:py-1 w-screen items-center px-4 z-20">
